//const operacion = require("../analizador/Analizador")
var  fs = require('fs');
var publico_id="";
var public_file="";
...
function agrega_tab() {
    ...
    btn.appendChild(document.createTextNode("Pestaña Nueva"));
...
function analizarP(){
    ...
    console.log(centrada.value);
    Inicio.prototype.start(centrada.value);
    traduce = Inicio.prototype.Traduccion();
    console.log(traduce +" traduccioooooooooooooooooooon");
    errores = Inicio.prototype.ListaErrores();
    alert(traduce);

    document.getElementById("txtsalida1"+publico_id).value =errores;
    /*fs.writeFile('Traduccion.py', traduce.value, function(err){
        if(err) throw err;
...
function analizar(){
    var centrada= document.getElementById("contenido_archivo"+publico_id);
    console.log(centrada.value);
    //var valor = document.getElementById("contenido_archivo");
    //console.log(valor);
