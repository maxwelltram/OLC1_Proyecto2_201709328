...
class Token {
    ...
    constructor(tipoDelToken: Tipo, val: string, fila: number, columna: number, contador: number) {
...
class ErrorAna{
    private valor:string;
    private contadorError:number;
    private fila:number;
    private columna:number;
    private informa:string;
    private tipo:string;
    ...
    constructor(contadorE:number, valor:string, fila:number, columna:number,descripcion:string,tipo:string){
        this.valor=valor;
        this.contadorError=contadorE;
        this.fila = fila;
        this.columna=columna;
        this.informa=descripcion;
        this.tipo=tipo;
    }
}

var listaError:Array<ErrorAna> = new Array<ErrorAna>();
...
class AnalizadorLexico {
    ...
    estado = 0; auxlex = ""; contadorToken = 1;ContadorError=0;
    fila=1; columna=0; columnaux=0;comprue=true;
    ...
    agregarError(DescripcionError:string, tipo:string){
        listaError.push(new ErrorAna(this.ContadorError, this.auxlex, this.fila, this.columna, DescripcionError, tipo))
        this.auxlex ="";
        this.ContadorError++;
        this.comprue=true;
        this.estado=0;
